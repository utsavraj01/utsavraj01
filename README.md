...
<div align="center">
  <h1 align="center">Hi <img src="https://raw.githubusercontent.com/ABSphreak/ABSphreak/master/gifs/Hi.gif" width="30px">, I'm Utsav raj</h1>
  ...
  <div style="margin-top: 20px;">
    <a href="https://www.linkedin.com/in/utsav-raj-638b16320?utm_source=share_via&utm_content=profile&utm_medium=member_android"><img src="https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn"/></a>
    <a href=":https://x.com/UtsavSingh01?t=SiVjDDgVe7aSZ4xRFu93Dg&s=09"><img src="https://img.shields.io/badge/Twitter-1DA1F2?style=for-the-badge&logo=twitter&logoColor=white" alt="Twitter"/></a>
    <a href="https://www.instagram.com/utsav_singh_rajput01?igsh=M2Q5cGVma2NjcGRl"><img src="https://"alt="Instagram"/></a>
    <a href="mailto:disav789@gmail.com"><img src="https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white" alt="Email"/></a>
  </div>
</div>
<!-- GitHub Metrics -->
<!-- <div align="center">
...
export class Developer {
  name: string = "Utsav Raj";
  education: string = "B.Tech in Computer Science Engineering (Full-Stack Domain)";
  location: string = "Gaya, Bihar, India";

  // Core Skills
  languages: string[] = ["JavaScript", "TypeScript", "Python", "C++"];
  ...
  currentFocus: string = "Building scalable full-stack applications & mastering cloud fundamentals";

  // Fun Facts
  usesOS: string = "Linux (Normal Linux user 😄)";
  favoriteBeverage: string = "Coffee while debugging ☕";
  motto: string = "Keep learning, keep building.";

  // Extras
  hobbies: string[] = ["Exploring Linux distros", "Learning new tech", "Music", "Debugging for fun"];
  strengths: string[] = ["Fast learner", "Team player", "Problem solver"];

  // Contact
  email: string = "disav789@gmail.com";

  greet(): string {
    return "Thanks for visiting! Always excited to collaborate and create something meaningful.";
  }
}
...
<div align="left">
  <h2><img src="https://media.giphy.com/media/iY8CRBdQXODJSCERIr/giphy.gif" width="35px">&nbsp; GitHub Stats</h2>
    <br>
    <a href="https://github-trophies.vercel.app/?username=utsavraj01" target="_blank">
      <img src="https://github-trophies.vercel.app/?username=utsavraj01&theme=monokai&no-frame=true&no-bg=true&margin-w=6&margin-h=6&row=1&column=9" width="100%">
    </a>
</div>
